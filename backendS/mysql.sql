INSERT INTO listing (title, image, description, price)
VALUES (
    ...
    (
        'Countryside Villa',
        'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8dmFjYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60',
        'Relax in the peaceful countryside in this charming villa surrounded by rolling hills and vineyards.',
        2200
    ),
    (
        'Tropical Bungalow',
        'https://images.unsplash.com/photo-1501785888041-af3ef285b470?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjF8fHRyYXZlbHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60',
        'Escape to this tropical paradise with stunning ocean views and lush surroundings.',
        1800
    ),
    (
        'Charming Cottage in Provence',
        'https://images.unsplash.com/photo-1598300050625-0a5050e3dcc2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dmFjYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60',
        'Enjoy the lavender fields and picturesque villages of Provence from this charming cottage.',
        1700
    ),
    (
        'Desert Oasis Retreat',
        'https://images.unsplash.com/photo-1533843892789-301cf86fb9e1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8dmFjYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60',
        'Find tranquility in the desert at this luxurious oasis retreat with stunning sunset views.',
        2400
    );